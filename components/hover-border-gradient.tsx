...
>) {
  ...
  const highlight = "radial-gradient(100% 180% at 50% 50%, #0ea5e9 0%, rgba(255, 255, 255, 0) 100%)";
  ...
  return (
    <Tag
      ...
      {...props}
    >
      <div className={cn("w-auto text-white z-10 bg-black/80 px-4 py-2 rounded-[inherit]", className)}>{children}</div>
      <motion.div
